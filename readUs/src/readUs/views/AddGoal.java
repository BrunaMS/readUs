			...
			public void actionPerformed(ActionEvent e) {
				...
				if (chckbxDefDates.isSelected()) {
					if (textFieldDesiredNumber.getText().isEmpty()) {
						...
						error = error
								+ "O campo numero desejado nao pode ser deixado vazio. Por favor insira um n�mero.\n";
						detectError = true;
					}
					if (textFieldConcludedNumber.getText().isEmpty()) {

						error = error
								+ "O campo numero concluido nao pode ser deixado vazio. Por favor insira um n�mero.\n";
						detectError = true;
					}
					if (dayBeggining.getItemCount() == 0) {

						error = error + "O campo dia do inicio pode ser deixado vazio. Por favor escolha uma op��o.\n";
						detectError = true;
					}
					if (monthBeggining.getItemCount() == 0) {

						error = error + "O campo mes do inicio pode ser deixado vazio. Por favor escolha uma op��o.\n";
						detectError = true;
					}
					if (yearBeggining.getItemCount() == 0) {

						error = error + "O campo ano do inicio pode ser deixado vazio. Por favor escolha uma op��o.\n";
						detectError = true;
					}
					...
					/*if (Integer.parseInt(textFieldDesiredNumber.getText()) > Integer.parseInt(textFieldConcludedNumber.getText())) {
						error = error
								+ "O n�mero concluido n�o pode ser maior que o desejado. Por favor confira seus valores.\n";
						detectError = true;
					}*/
				} else {
					...
					if (textFieldDesiredNumber.getText().isEmpty()) {
						...
						error = error
								+ "O campo numero desejado n�o pode ser deixado vazio. Por favor insira um n�mero.\n";
						detectError = true;
					}
					if (textFieldConcludedNumber.getText().isEmpty()) {

						error = error
								+ "O campo numero concluido n�o pode ser deixado vazio. Por favor insira um n�mero.\n";
						detectError = true;
